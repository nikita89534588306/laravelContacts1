    ...
    <div class="contactDetail-header row justify-content-center ">
        ...
        <form action='{{route("contact.store")}}' method='post' class="row justify-content-center mt-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-11">
                    <input type="phone" name="phone1" class="form-control mb-3" placeholder="Номер телефона">
                    <input type="phone" name="phone2" class="form-control mb-3" placeholder="Номер телефона">    
                    <input type="phone" name="phone3" class="form-control mb-3" placeholder="Номер телефона">  
                </div>
            </div>
