        ...
        <form action='{{route("contact.store")}}' method='post' class="row justify-content-center mt-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-11 phones_input">
                    <input type="phone" name="phone_1" id='phone_1' class="form-control mb-3" placeholder="Номер телефона">
                </div>
            </div>
...
<script>
    ...
    function createInput(){
        ...
        newInputPhone.name = 'phone_id' + Date.now();
        ...
        newInputPhone.addEventListener('input', deleteInput)
        
    }
    function deleteInput(){ if(this.value === '') this.remove();}
    phoneInput.addEventListener('input', createInput)
    phoneInput.addEventListener('input', deleteInput)
