    ...
    <div class="contactDetail-header row justify-content-center ">
        ...
        <form class="row justify-content-center mt-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-11">
                    <input type="email" class="form-control mb-3" placeholder="Имя" id="exampleInputEmail1" aria-describedby="emailHelp">
                    <input type="email" class="form-control mb-3" placeholder="Фамилия" id="exampleInputEmail1" aria-describedby="emailHelp">    
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-1">
                ...
                <div class="col-11">
                    <input type="email" class="form-control mb-3" placeholder="Номер телефона" id="exampleInputEmail1" aria-describedby="emailHelp">
                    <input type="email" class="form-control mb-3" placeholder="Номер телефона" id="exampleInputEmail1" aria-describedby="emailHelp">    
                </div>
            </div>
